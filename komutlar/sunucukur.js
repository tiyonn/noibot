...
$let[kategori;$createChannel[Main;category;yes]]
    ...
    $onlyIf[$getGlobalUserVar[kurallar]==onaylandı;{title:Hata}{Botumuzun kurallarını onaylamadan komutlarımızı kullanamazsınız. Kuralları görmek için \`-kurallar\` yazabilirsiniz!}{footer:Noibot daima hizmetinizde!}{color:RED}]
    `
})